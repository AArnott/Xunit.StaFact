...
namespace Xunit.Sdk
{
    ...
    public class WinFormsTheoryDiscoverer : TheoryDiscoverer
    {
        ...
        {
            yield return new UITheoryTestCase(UITestCase.SyncContextType.WinForms, this.DiagnosticMessageSink, discoveryOptions.MethodDisplayOrDefault(), TestMethodDisplayOptions.None, testMethod);
        }
    }
}
