...
public class CocoaTheoryDiscoverer : TheoryDiscoverer
{
    ...
    {
        IReadOnlyCollection<IXunitTestCase> testCases = CocoaUtilities.CreateTestCasesForDataRow(
            discoveryOptions,
            testMethod,
            theoryAttribute,
            dataRow,
    ...
    {
        IReadOnlyCollection<IXunitTestCase> testCases = CocoaUtilities.CreateTestCasesForTheory(
            discoveryOptions,
            testMethod,
            theoryAttribute);
        return new(testCases);
